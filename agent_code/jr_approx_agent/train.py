...
GAME_REWARDS = {
    ...
    ce.POTENTIAL_TO_DIE_BY_EXPLOSION: -0.03,
    ce.POTENTIAL_TO_NOT_DIE_BY_EXPLOSION: 0.03,
    ce.POTENTIAL_TO_EXPLODE_CRATE: 0.015,
    ce.POTENTIAL_TO_NOT_EXPLODE_CRATE: -0.015,
